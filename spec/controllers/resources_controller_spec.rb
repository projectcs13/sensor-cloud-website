...
describe ResourcesController do
  ...
  # before { SessionsHelper::current_user=(User.new) }

  # This should return the minimal set of attributes required to create a valid
  # Resource. As you add validations to Resource, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyResource", "owner" => 0, "user_id" => 0 } }
  ...
  describe "GET index" do
    it "assigns all resources as @resources" do
      resource = Resource.build valid_attributes
  ...
  describe "GET edit" do
    it "assigns the requested resource as @resource" do
      resource = Resource.build valid_attributes
      get :edit, {:id => resource.id}, valid_session
      assigns(:resource).should eq(resource)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created resource's edit window" do
        post :create, {:resource => valid_attributes}, valid_session
        response.should redirect_to(edit_resource_path(Resource.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested resource" do
        ...
        Resource.any_instance.should_receive(:update).with({ "name" => "MyString" })
